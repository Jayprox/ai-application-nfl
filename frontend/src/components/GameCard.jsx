      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <Link to={`/teams/${game.away_team_id}`} className="font-medium text-slate-900 text-sm hover:underline">
              {game.away_team_abbr}
            </Link>
            <span className="text-slate-400 text-sm">@</span>
            <Link to={`/teams/${game.home_team_id}`} className="font-medium text-slate-900 text-sm hover:underline">
              {game.home_team_abbr}
            </Link>
