  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-canvas px-4">
      <div className="w-full max-w-sm">
        <h1 className="font-display text-3xl font-semibold uppercase tracking-wide text-ink text-center mb-1">
          Chalk That <span className="text-ink-faint">NFL</span>
        </h1>
        <p className="text-sm text-ink-dim text-center mb-6">Stats research, no props.</p>
        ...
        >
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-md bg-accent text-on-accent text-sm font-medium py-2 hover:brightness-110 disabled:opacity-50"
          >
